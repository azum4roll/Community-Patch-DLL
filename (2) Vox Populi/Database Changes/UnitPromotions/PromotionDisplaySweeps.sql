...
VALUES
	...
	('PROMOTION_FREE_PILLAGE_MOVES', 132),
	...
	('PROMOTION_VERDANT_TREKKER', 341),
	('PROMOTION_FIELD_RUNNER', 342),
	('PROMOTION_DESERT_DWELLER', 343),
	('PROMOTION_FROST_WALKER', 344),
	('PROMOTION_MOUNTAINEER', 345),
	('PROMOTION_WATERBORNE', 346),
	('PROMOTION_FORAGER', 347),
	('PROMOTION_SURVIVALISM', 348),
	('PROMOTION_HALO_JUMPER', 349),
	-- Unit free promotions (stays on upgrade)
	('PROMOTION_RECONNAISSANCE', 413),
	('PROMOTION_OCEAN_EXPLORER', 414),
	('PROMOTION_SCAVENGER', 416),
	('PROMOTION_JAMMER', 417),
	...
	-- Belief promotions
	('PROMOTION_ANIMISM', 599), -- IGNORE_TERRAIN_COST but restricted to missionaries
	-- Policy promotions
	...
	-- Trait promotions
	('PROMOTION_CHASQUI_TRAINING', 793),
