...
---Add a localized yield modifier text to the given tooltip table based on the given yield modifier table<br>
---Example lines:<br>
---`During "We Love the King Day": +15% [ICON_PRODUCTION] Production +15% [ICON_GOLD] Gold`<br>
---`During Golden Age: +20% [ICON_RESEARCH] Science`
---@param tTooltipList string[] List of tooltip strings/lines to be added to
...
function GetHelpTextForBuilding(eBuilding, bExcludeName, _, bNoMaintenance, pCity)
	...
	-- Yield boosts and modifiers on other components
	...
	for eYield = 0, iNumYields - 1 do
		...
		for row in GameInfo.Building_AreaYieldModifiers{BuildingType = kBuildingInfo.Type, YieldType = kYieldInfo.Type} do
			tAreaBoosts[eYield] = row.Yield;
		end
	end
	...
	-- Instant great person points on birth
	AddTooltipPositive(tLocalAbilityLines, "TXT_KEY_PRODUCTION_BUILDING_GPP_ON_BIRTH", kBuildingInfo.GPPOnCitizenBirth);
